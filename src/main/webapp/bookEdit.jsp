...
<html lang="${language}">
        ...
        <body>
            ...
            <div class="container">
                <h2>Edit Book</h2>
                <hr />
                <form name="editBook" method="POST" action="BookController">
                    <div class="row">
                        <div class="form-group col-xs-5">
                            <label for="bookId">Book ID</label>
                            <input type="text" class="form-control" id="bookId" name="bookId" value="${book_id}" readonly="readonly">
                    ...
                    <div class="row">
                        <div class="col-xs-5">
                            ...
                            <button type="submit" id="save" class="btn btn-primary" name="submit" value="editSave">Save</button>
                        </div>
                    </div>
                </form>
                <br>
